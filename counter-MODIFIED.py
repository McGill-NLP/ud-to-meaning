...
from DRS_parsing.evaluation.hill_climbing import *
...
from DRS_parsing.evaluation.html_results import coda_html
# Import utils
from DRS_parsing.evaluation.utils_counter import *
...
def get_clauses(file_name, signature, ill_type, include_ref):
...
def main(args):
	...
	from DRS_parsing.evaluation.wordnet_dict_en import en_sense_dict
	signature = get_signature(args.sig_file) # Get signature
	res = []

	# Get all the clauses and check if they are valid # MARK this is how I'll have to pass them
	clauses_gold_list, original_gold = get_clauses(args.f2, signature, args.ill, args.include_ref)
	clauses_prod_list, original_prod = get_clauses(args.f1, signature, args.ill, args.include_ref)
